...
umrljivost1 <- umrljivost
umrljivost2 <- umrljivost

umrljivostG1 <- umrljivost %>% filter(stevilo, grupe == "1")
stevilo2 <- (umrljivostG1[3])^2  
sum(stevilo2) # 5621173

umrljivostG2 <- umrljivost1 %>% filter(stevilo, grupe == "2")
stevilo3 <- (umrljivostG2[3]) ^2
sum(stevilo3) # 114945

umrljivostG3 <- umrljivost %>% filter(stevilo, grupe == "3")
stevilo4 <- (umrljivostG3[3]) ^2
sum(stevilo4) # 1616445
...
umrlj1 <- umrljivost.brez.odstopanja
umrlj2 <- umrljivost.brez.odstopanja
umrlj3 <- umrljivost.brez.odstopanja

umrljG1 <- umrlj1 %>% filter(stevilo, grupe == "1")
stevilo2 <- (umrljG1[3])^2  
sum(stevilo2) # 2177624

umrljG2 <- umrlj2 %>% filter(stevilo, grupe == "2")
stevilo3 <- (umrljG2[3])^2
sum(stevilo3) # 90736

umrljG3 <- umrlj3 %>% filter(stevilo, grupe == "3")
stevilo4 <- (umrljG3[3]) ^2
sum(stevilo4) # 1183622
